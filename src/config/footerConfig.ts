// 页脚配置（菜单 / 格言 / 徽章）
import beianImg from '../assets/io/beian.svg';
import blueImg from '../assets/io/blue.svg';
import moeImg from '../assets/io/moe.svg';
export const footerConfig = {
  ...
  footerBadges: JSON.stringify([
    ...
    { title: '本站已备案', href: 'https://beian.miit.gov.cn/', img: beianImg.src },
    { title: '本站已公安网站备案', href: 'https://beian.mps.gov.cn/#/query/webSearch?code=32083002000282', img: blueImg.src },
    { title: '本站已加入萌ICP，萌ICP备20230187号', href: 'https://icp.gov.moe/?keyword=20230187', img: moeImg.src },
